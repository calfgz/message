...
<body>
	<div id="login">
		<div id="login_header">
			<h1 class="login_logo">
				<a href="http://sms.51qtt.com"><img src="themes/default/images/login_logo.png" /></a>
			</h1>
			...
			<div class="loginForm">
				<form action="login.do" method="post">
					...
					<p>
						...
						<span><img id="captcha_img" src="captcha.do" alt="" width="75" height="24" /></span>
					</p>
					<div class="login_bar">
		...
		<div id="login_footer">
			Copyright &copy; 2015 www.51qtt.com Inc. All Rights Reserved. <a href="http://www.miitbeian.gov.cn/state/outPortal/loginPortal.action" target="_blank">粤ICP备12024091号-7</a>
		</div>
	</div>
</body>
<script type="text/javascript">
$(function(){         
    $('#captcha_img').click(function () {//生成验证码  
