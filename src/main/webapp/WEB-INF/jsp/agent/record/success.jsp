...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/agent/record/success.do" method="get">
	<div class="searchBar">
		<table class="searchContent"> 
				<tbody>
					<tr>
						<td>ID：<input type="text" name="smsid" class="textInput" value="${param.smsid}">
						</td>
					</tr>
				</tbody>
			</table>
...
<div class="panelBar">
<ul class="toolBar">
<li><a class="icon" href="${ctx}/admin/record/senddetail.do?id={id}"  target="navTab" rel="detail-sendrecord" title="短信详情"><span>查看详情</span></a></li> 
