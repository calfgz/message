...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/admin/failrecord/list.do" method="get">
	<div class="searchBar">
...
<div class="panelBar">
<ul class="toolBar">
<li><a class="icon" href="${ctx}/admin/failrecord/detail.do?id={id}"  target="navTab" rel="detail-failrecord" title="短信详情"><span>查看详情</span></a></li> 
